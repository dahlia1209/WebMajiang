...
export class Paipu {
    ...
    public _log_idx:any;
    public _idx:any;
    public _deny_repeat:any;
    public _repeat_timer:any;
    public _autoplay:any;
    public _autoplay_timer:any;
    public _speed:any;
    public _summary:any;
    public _callback:any;
    public _open_analyzer:any;
    public _repeet:any;
    public _analyzer:any;
    public _fragment_base:any;
    public _redo:any;

    constructor(root:any, paipu:any, pai:any, audio:any, pref:any, callback:any, analyzer:any) {
        this._root  = root;
        this._paipu = paipu;
    ...
    get_pref() {
        const p=localStorage.getItem(this._pref)
        if (p) {
            return JSON.parse(p);
        }
        else {
    ...
    set_handler() {
        ...
        this._root.on('mousedown', (ev:any)=>{
        ...
        $(window).on('keydown.paipu', (ev:any)=>{
    ...
    summary() {
        ...
        for (let i = 0; i < this._paipu.log.length; i++) {
            $('.summary tbody tr', this._root).eq(i)
                .on('mousedown', (ev:any)=> this.top(i));
        }
    ...
    speed(speed:any) {
        ...
        this._speed = speed;
        const ctrl = $('.controller', this._root);
        $('.speed span', ctrl).each((i:any, n:any)=>{
